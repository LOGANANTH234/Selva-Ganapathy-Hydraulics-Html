...
export default function ElectricMachinesPage() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [machinesResponse, typesResponse] = await Promise.all([
          getMachinesByParentType("electric"),
          getMachineTypesByParentType("electric"),
        ])
      ...
      <main className="min-h-screen bg-white border border-gray-200">
        <div className="container mx-auto px-4 py-6">
          <div className="mb-6 border-b border-gray-200 pb-4">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-black mb-3">Electric Motor Machines</h1>
          </div>
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="mb-6 border-b border-gray-200 pb-4">
          ...
          <p className="text-gray-600 text-base max-w-3xl">
            Explore our range of electric motor-powered hydraulic machines designed for efficient, consistent, and
            reliable wood processing operations.
          </p>
        </div>
